...
#"Version=6" >> C:\Windows\System32\GroupPolicy\gpt.ini


#mkdir C:\Windows\System32\GroupPolicy\Machine\Scripts

#"[Startup]" >> C:\Windows\System32\GroupPolicy\Machine\Scripts\scripts.ini
#"0CmdLine=C:\onstart.ps1" >> C:\Windows\System32\GroupPolicy\Machine\Scripts\scripts.ini
#"0Parameters=" >> C:\Windows\System32\GroupPolicy\Machine\Scripts\scripts.ini
#"[Shutdown]" >> C:\Windows\System32\GroupPolicy\Machine\Scripts\scripts.ini
#"0CmdLine=C:\onstop.ps1" >> C:\Windows\System32\GroupPolicy\Machine\Scripts\scripts.ini
#"0Parameters=" >> C:\Windows\System32\GroupPolicy\Machine\Scripts\scripts.ini
