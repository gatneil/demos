...
az vmss create --resource-group $rgname --name $vmssname --image UbuntuLTS --instance-count 1000 --app-gateway myAppGW --app-gateway-capacity 10 --backend-port 5000 --upgrade-policy-mode Automatic --vnet-address-prefix 10.0.0.0/20 --subnet-address-prefix 10.0.0.0/21
...
az vmss create --resource-group $rgname --name $vmname --image UbuntuLTS --nsg "" --size $vmsku --instance-count 100
