...
curl -UseBasicParsing https://raw.githubusercontent.com/gatneil/demos/master/onstartstop-windows-unmanaged/onstart.ps1 | select -Expand Content >> C:\onstart.ps1
curl -UseBasicParsing https://raw.githubusercontent.com/gatneil/demos/master/onstartstop-windows-unmanaged/onstop.ps1 | select -Expand Content >> C:\onstop.ps1
